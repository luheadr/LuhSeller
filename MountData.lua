BINDING_HEADER_LUHMOUNT_HEADER = "LuhUtilities Mount"
BINDING_NAME_LUHMOUNT = "Mount/Dismount"
BINDING_NAME_LUHMOUNT_GROUND = "Mount/Dismount (no flying)"
BINDING_NAME_LUHMOUNT_PASSENGER = "Mount/Dismount Passenger Mounts"
